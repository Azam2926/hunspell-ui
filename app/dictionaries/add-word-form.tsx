...
import { addAction } from "@/lib/actions/dictionary";
...
const affixGroups = [
  { id: 1, flag: "A", type: "SFX", description: "Plural forms" },
  { id: 2, flag: "B", type: "PFX", description: "Negative prefix" },
  { id: 3, flag: "C", type: "SFX", description: "Verb conjugation" },
  { id: 4, flag: "D", type: "PFX", description: "Adjective prefix" },
  { id: 5, flag: "E", type: "SFX", description: "Comparative forms" },
  { id: 6, flag: "F", type: "PFX", description: "Possessive prefix" },
];
...
export function AddWordForm({
  ...
  const onSubmit = async (values: FormValues) => {
    try {
      ...
      // Call the server action to add the dictionary entry
      ...
      toast("Error", {
        description: "Failed to add word to dictionary.",
      });
    }
  };
